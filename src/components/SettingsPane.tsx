...
export function SettingsPane({ workspacePath }: Props) {
  ...
  const loadCursorStatus = useCallback(async () => {
    ...
    try {
      ...
      if (
        ...
        setProvidersMessage(
          "Cursor connectÃ© â€” vous pouvez fermer l'onglet du navigateur et revenir Ã  Sinew.",
        );
  ...
  const connectCursor = useCallback(async () => {
    ...
    try {
      ...
      await api.openExternalUrl(login.authUrl);
      setProvidersMessage(
        "Connectez-vous dans le navigateur (Google ou GitHub). La page dira Â« return to Cursor Â» â€” c'est normal : revenez ici, Sinew se connectera automatiquement.",
      );
    } catch (err) {
      cursorOAuthPendingRef.current = false;
      setProvidersMessage(err instanceof Error ? err.message : String(err));
...
function OptionsSection({
  ...
  return (
    <div className="settings-pane__body settings-pane__body--about" style={{ display: "flex", flexDirection: "column", gap: "24px" }}>
      ...
      {/* ========================================================================= */}
      {/* ðŸŽ¨ CARTE GENERALE 1 : APPARENCE & INTERFACE                               */}
      {/* ========================================================================= */}
        ...
        <div className="options-category-grid">
          ...
          <div className="settings-pane__about-card">
            ...
            <div className="settings-pane__locale-switch" role="radiogroup" aria-label="Theme">
              ...
              >
                {locale === "fr" ? "ðŸ’» SystÃ¨me" : "ðŸ’» System"}
              </button>
              <button
                type="button"
                role="radio"
              ...
              >
                {locale === "fr" ? "âœ¨ IA (Moderne / Verre)" : "âœ¨ AI (Modern / Glass)"}
              </button>
            </div>
          </div>
          ...
          <div className="options-subcategory-row">
            ...
            <div className="settings-pane__about-card" style={{ flex: 1 }}>
              <div className="settings-pane__about-card-copy">
                <h2>{locale === "fr" ? "Taille du texte (Ã‰diteur)" : "Editor Font Size"}</h2>
                <p>
                  {locale === "fr"
      ...
      {/* ========================================================================= */}
      {/* âš¡ CARTE GENERALE 2 : MODE POWER USER & COMPORTEMENTS DE L'AGENT         */}
      {/* ========================================================================= */}
      <div className="options-category-group">
        <h3 className="options-category-title">
        ...
        <div className="options-category-grid">
          ...
          <div className="settings-pane__about-card">
            <div className="settings-pane__about-card-copy">
              <h2>
                <span style={{ color: "var(--accent-hi)", marginRight: "6px" }}>ðŸ§ </span>
      ...
      {/* ========================================================================= */}
      {/* ðŸ”„ CARTE GENERALE 3 : SYSTEME & DIAGNOSTICS                               */}
      {/* ========================================================================= */}
      <div className="options-category-group">
        <h3 className="options-category-title">
        ...
        <div className="options-category-grid">
          ...
          {/* Pacte de LibÃ©ration Symbiotique ðŸ§¬ */}
          <div className="settings-pane__about-card" style={{ flexDirection: "column", gap: "16px", alignItems: "stretch" }}>
            <div className="settings-pane__about-card-header-flex">
              <div className="settings-pane__about-card-copy">
                <h2>
    ...
    <div className="settings-pane__body settings-pane__body--about">
      ...
      <div className="settings-pane__fork-section" style={{
        ...
        <h2 style={{
          ...
          {locale === "fr" ? "Fork JulienPiron.fr â€” AmÃ©liorations ClÃ©s" : "JulienPiron.fr Fork â€” Key Enhancements"}
        </h2>
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{ fontSize: "11px", color: "var(--text-2)", lineHeight: 1.4 }}>
              {locale === "fr" 
                ? "Sauvegarde automatique SOTA 1.5s aprÃ¨s la frappe. Ã‰cran de mises Ã  jour sÃ©curisÃ© et synchronisation OneDrive & SQLite automatique."
    ...
    <div style={{ display: "flex", flexDirection: "column", gap: "4px", minWidth: 0 }}>
      <div style={{ display: "flex", justifyContent: "space-between", gap: "8px", fontSize: "11px", minWidth: 0 }}>
        ...
        <span style={{
          ...
          minWidth: 0,
          flex: "0 0 auto"
        }} title={percent == null ? "â€”" : `${percent.toFixed(0)}%${reset ? ` - ${reset}` : ""}`}>
          {percent == null ? "â€”" : `${percent.toFixed(0)}%`}{reset ? ` - ${reset}` : ""}
        </span>
      </div>
                  ...
                  <div className="settings-pane__tool-toggle-text">
                    ...
                    <span className="settings-pane__tool-toggle-hint">
                      {openAiConnected
                        ...
                        : "Connecte OpenAI dans ParamÃ¨tres â†’ Providers pour utiliser ton abonnement."}
                    </span>
                  </div>
                  <button
                    type="button"
                  ...
                  <div className="settings-pane__tool-toggle-text">
                    ...
                    <span className="settings-pane__tool-toggle-hint">
                      {googleConnected
                        ...
                        : "Connecte Google dans ParamÃ¨tres â†’ Providers pour utiliser ton abonnement."}
                    </span>
                  </div>
                  <button
                    type="button"
        ...
        {server.id === "sinew-chrome" && (
          <div className="settings-pane__chrome-bridge-repair" style={{
            ...
            <div style={{
              ...
              âš ï¸ IMPORTANT : Pour que l'automatisation fonctionne, vous devez Ã©galement charger l'extension une premiÃ¨re fois dans Google Chrome. 
        ...
        <div className="settings-pane__provider-copy">
          ...
          {connected && displayStatus.models && displayStatus.models.length > 0 && (
            <div style={{ fontSize: "11px", opacity: 0.9, color: "var(--color-success)", marginTop: "10px" }}>
              <strong>âœ“ ModÃ¨les vÃ©rifiÃ©s sur votre clÃ© :</strong>{" "}
