            ...
            <div className="options-subcategory-row">
              ...
              <div className="settings-pane__about-card" style={powerUserMaster !== "custom" ? { opacity: 0.55, pointerEvents: "none" } : undefined}>
                <div className="settings-pane__about-card-copy">
                  ...
                  <p>
                    {locale === "fr"
                      ? "Génère spontanément des schémas Mermaid et des plans visuels pour illustrer vos explications, sans pour autant bloquer chaque petite édition de fichier."
                      : "Proactively generates Mermaid diagrams and visual layouts to illustrate explanations, without blocking on every minor file edit."}
                  </p>
                </div>
        ...
        {server.id === "sinew-chrome" && (
          <div className="settings-pane__chrome-bridge-repair" style={{
            ...
            <div style={{
              ...
              ⚡ï¸ IMPORTANT : Pour que l'automatisation fonctionne, vous devez également charger l'extension une première fois dans Google Chrome. 
