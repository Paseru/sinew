...
const EXACT_TRANSLATIONS: Record<string, string> = {
  ...
  "Run your local Ollama models. Detects every installed model automatically.": "Utilisez vos modèles Ollama locaux. Détecte automatiquement tous les modèles installés.",
  "Refresh models": "Actualiser les modèles",
  "Disconnect Ollama": "Déconnecter Ollama",
