...
use crate::client::OllamaCatalogModel;

pub const PROVIDER_ID: &str = "ollama";

pub fn capabilities_from_catalog_model(model: &OllamaCatalogModel) -> ModelCapabilities {
...
fn preferred_window(context_window: u32) -> u32 {
    ((context_window as u64 * 9) / 10).max(1).min(u32::MAX as u64) as u32
}
